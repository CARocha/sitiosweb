...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'publicaciones_publicaciones', (
            ...
            ('categoria', self.gf('tagging_autocomplete.models.TagAutocompleteField')(null=True)),
    ...
    models = {
        ...
        u'publicaciones.publicaciones': {
            'Meta': {'object_name': 'Publicaciones'},
            ...
            'categoria': ('tagging_autocomplete.models.TagAutocompleteField', [], {'null': 'True'}),
